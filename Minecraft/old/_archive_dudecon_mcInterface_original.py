...
class SaveFile(object):
    ...
    '''
    def map_height(self):
        '''return the top height of the map, which is 127.'''
        return 127
...
###mc_level.write_dat()
## print out a chunk
#chunk = mc_level.get_chunk(-1,5)
#print(chunk)
#from random import random, choice
#from math import pi, sin, cos
#for throwaway in range(1627):
    #rad_fraction = random()
    #rad = rad_fraction * 30
    #ang = random() * pi * 2
    #x = 0 + int(rad * sin(ang) + .5)
    #z = 60 + int(rad * cos(ang) + .5)
    #y = choice(range(128))
    ##print(x, y, z)
...
# To Do
# Allow import of custom data files?
