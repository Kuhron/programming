...
if __name__ == "__main__":
    ...
    learning_rate = 0.01  # usually between 1e-6 and 0.1
    ...
    for round_i in range(10):
        ...
        for receiving_neuron_i in range(n_receiving_neurons):
            ...
            for sample_i in range(n_data_points):
                ...
                print("raw {}, activated {}, correct {}, loss {}, gradloss {}".format(raw_output_this_sample, output_this_sample, correct_output, loss_this_sample, gradient_loss_this_sample))
