...
if __name__ == "__main__":
    ...
    h_stretch_parameters = np.random.uniform(0, 1, 10000)**0.25  # skew towards 1
    df = nm.add_random_data_sigmoid_decay_hills(df, "elevation", n_hills=10000, h_stretch_parameters=h_stretch_parameters)
